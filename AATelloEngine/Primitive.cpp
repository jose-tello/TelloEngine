...
void Primitive::CreateCube(std::vector<float>& vertices, std::vector<unsigned int>& indices)
{
...
void Primitive::CreatePiramid(std::vector<float>& vertices, std::vector<unsigned int>& indices)
{
...
void Primitive::CreateSphere(float radius, unsigned int rings, unsigned int sectors, std::vector<float>& vertices, std::vector<float>& normals,
...
void Primitive::CreateCilinder(float radius, unsigned int sectorCount, float height, std::vector<float>& vertices, std::vector<float>& normals,
	std::vector<float>& texCoords, std::vector<unsigned int>& indices)
{
