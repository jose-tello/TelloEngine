...
bool W_Scene::Draw()
{
	...
	App->renderer3D->DrawScene(frameBuffer, textureBuffer, previewFrameBuffer, previewTextureBuffer, camera, size.x, size.y, !App->camera->debugFrustumCull, App->camera->drawAABB);
