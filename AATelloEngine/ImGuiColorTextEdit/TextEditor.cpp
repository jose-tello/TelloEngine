...
float TextEditor::TextDistanceToLineStart(const Coordinates& aFrom) const
{
	...
	float distance = 0.0f;
	float spaceSize = ImGui::GetFont()->CalcTextSizeA(ImGui::GetFontSize(), FLT_MAX, -1.0f, " ", nullptr, nullptr).x + 1;
...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::GLSL()
{
	...
	if (!inited)
	{
		static const char* const keywords[] = {
			...
			"_Noreturn", "_Static_assert", "_Thread_local", "bool", "vec2", "vec3", "vec4", "mat2", "mat3", "mat4", "sampler2D", "sampler1D", "location", "ivec2", "ivec3", "ivec4", "image2D"
		};
		for (auto& k : keywords)
			langDef.mKeywords.insert(k);
		...
		static const char* const identifiers[] = {
			...
			"samplerCube", "sin", "cos", "tan", "fract", "gl_GlobalInvocationID", "imageStore", "inverse", "true", "false", "texelFetch", "imageSize", "step", "sign"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
